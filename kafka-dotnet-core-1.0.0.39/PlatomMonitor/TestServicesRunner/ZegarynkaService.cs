...
{
    public class ZegarynkaService : IDummyService
    {
        ...
        private MessageSequence sequence_time;
        private MessageSequence sequence_date;

        public bool Enabled { get; set; }


        public ZegarynkaService()
        {
        }

        public void Setup()
        {
            this.service_name =  "Zegarynka";
            ...
            this.sequence_time = MessageSequence.CreateProducerSequence(this.service_name, "TimeChannel", "schema_TimeChannel");
            this.sequence_date = MessageSequence.CreateProducerSequence(this.service_name, "DateChannel", "schema_TimeChannel");
            this.Enabled = true;
                ...
                while (!ct.IsCancellationRequested)
                {
                    ...
                    StatusPayload status_payload =
                        StatusPayload.FromSequenceHeaders(this.service_name,
                            new[] {this.sequence_date, sequence_time}, new MessageSequence[0], 10 * 1000, 7 * 1000);
